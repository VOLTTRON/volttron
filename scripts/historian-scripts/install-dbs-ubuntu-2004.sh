...
function install_mongodb(){                                                                        
  ...
  tar -xvzf mongodb-linux-x86_64-ubuntu2004-7.0.1.tgz
  ln -s mongodb-linux-x86_64-ubuntu2004-7.0.1 mongodb
  mkdir data                                                                                       
  mkdir log  
  ...
  tar -xvzf mongosh-1.10.6-linux-x64-openssl11.tgz
  mv mongosh-1.10.6-linux-x64-openssl11/bin/* /databases/mongodb/mongodb/bin
