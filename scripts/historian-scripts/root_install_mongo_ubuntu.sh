...
mongo $db_name -u $admin_user -p $admin_passwd --authenticationDatabase $db_name --eval 'db.createUser( {user: "'$volttron_user'", pwd: "'$volttron_passwd'", roles: [ { role: "readWrite", db: "'$db_name'" }]});'
