...
def build_configs():
    ...
    #config_builder.build_master_config(test_settings.platform_driver_file, config_dir, config_paths)
    config_builder.build_master_config(test_settings.platform_driver_file,
                                       config_full_path,
                                       config_paths,
                                       True,
                                       5,
