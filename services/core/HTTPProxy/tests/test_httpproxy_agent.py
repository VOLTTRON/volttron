...
from services.core.HTTPProxy.httpproxy.agent import HttpProxy
...
HttpProxy.__bases__ = (AgentMock.imitate(Agent, Agent()),)
agent = HttpProxy()
...
@mock.patch.object(HttpProxy, 'grequests_wrapper', get_mock_response)
@pytest.mark.httpproxy
...
def test_get_driver_data():
    ...
    :return:
    """
    content = get_mock_response(None, "get", None, None)
    group_id = "testid"
    group2_id = "testid2"
    driver_type = "testdriver"
    ...
    driver_data_start = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS,
    ...
    driver_data_repeat = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS,
                                               update_frequency=update_frequency)
    ...
    driver_data_new = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS,
                                            update_frequency=update_frequency)
    ...
    driver_data_refresh = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS, refresh=True,
                                                update_frequency=update_frequency)
    ...
    driver_data_rm = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS,
                                           update_frequency=update_frequency)
    ...
    driver_data_rerepeat = agent.get_driver_data(driver_type, group_id, "get", TEST_URL, HEADERS,
                                                 update_frequency=update_frequency)
    ...
    driver2_data = agent.get_driver_data(driver2_type, group_id, "get", TEST_URL, HEADERS,
                                         update_frequency=update_frequency)
    ...
    group2_data = agent.get_driver_data(driver2_type, group2_id, "get", TEST_URL, HEADERS,
                                        update_frequency=update_frequency)
    ...
    # This type shouldn't be supported
    with pytest.raises(ValueError, match=r"Unsupported request type for HTTP Proxy Agent: .+"):
        fail_data = agent.get_driver_data(driver_type, group_id, "BAD", TEST_URL, HEADERS,
                                          update_frequency=update_frequency)
        print(fail_data)
