...
sqlite_connection.execute("PRAGMA CACHE_SIZE=-16000")
...
def insert_test_data():
    cursor = mongodb.topics_tag_test.find(
...
if __name__ == '__main__':
    ...
    #insert_test_data()# now perform test query and time them
    query_topics_by_tags()
    db_close()
