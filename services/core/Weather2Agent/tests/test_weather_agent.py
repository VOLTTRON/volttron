...
@pytest.mark.parametrize(("locations", "result_topics"), [
    ...
    ([{"zip": "99353"}], ['weather2/polling/current/ZIP/99353/all']),

    # Multiple zip code locations
    ([{"zip": "99353"}, {"zip": "99354"}],
     ['weather2/polling/current/ZIP/99353/all',
      'weather2/polling/current/ZIP/99354/all']),

    # Single city and state
    ([{"city": "Richland", "region": "WA"}],
     ['weather2/polling/current/WA/Richland/all']),

    # Multiple cities and states
    ([{"city": "Richland", "region": "Washington"},
      {"city": "Kennewick", "region": "Washington"}],
     ['weather2/polling/current/Washington/Richland/all',
      'weather2/polling/current/Washington/Kennewick/all'])
])
...
@pytest.mark.parametrize(
    ...
    [
        ([{"zip": "6000652"}],
         'weather2/error/current/ZIP/6000652/all',
         'querynotfound:No cities match your search query'),

        ([{"city": "Richland2", "region": "Washington"}],
         'weather2/error/current/Washington/Richland2/all',
         'querynotfound:No cities match your search query'),
...
@pytest.mark.parametrize(("request_topic", "response_topic"), [
    # zip
    ("{}/current/ZIP/99353/all".format(topics.NEW_WEATHER_REQUEST),
     "{}/current/ZIP/99353/all".format(topics.NEW_WEATHER_RESPONSE)),
    # region, city
    ("{}/current/WA/Richland/all".format(topics.NEW_WEATHER_REQUEST),
     "{}/current/WA/Richland/all".format(topics.NEW_WEATHER_RESPONSE))
...
@pytest.mark.parametrize(("request_topic", "response_topic"), [
    ...
    ("{}/history/ZIP/99353/all/2018-06-26".format(topics.NEW_WEATHER_REQUEST),
     "{}/history/ZIP/99353/all/2018-06-26".format(topics.NEW_WEATHER_RESPONSE)),

    # region, city - end date defaults to start +1 day
    ("{}/history/WA/Richland/all/2018-06-26".format(
        topics.NEW_WEATHER_REQUEST),
     "{}/history/WA/Richland/all/2018-06-26".format(
         topics.NEW_WEATHER_RESPONSE)),
...
@pytest.mark.parametrize(("request_topic", "response_topic"), [
    # zip - forecast 3
    ("{}/hourly/ZIP/99353/all".format(topics.NEW_WEATHER_REQUEST),
     "{}/hourly/ZIP/99353/all".format(topics.NEW_WEATHER_RESPONSE)),

    # region, city
    ("{}/hourly/WA/Richland/all".format(topics.NEW_WEATHER_REQUEST),
     "{}/hourly/WA/Richland/all".format(
         topics.NEW_WEATHER_RESPONSE)),

    # zip - forecast 10
    ("{}/hourly10days/ZIP/99353/all".format(topics.NEW_WEATHER_REQUEST),
     "{}/hourly10days/ZIP/99353/all".format(topics.NEW_WEATHER_RESPONSE)),

    # region, city
    ("{}/hourly10days/WA/Richland/all".format(topics.NEW_WEATHER_REQUEST),
...
@pytest.mark.parametrize(
    ...
    [
        ("{}/current/ZIP/99353".format(topics.NEW_WEATHER_REQUEST),
         '{}/current/ZIP/99353'.format(topics.NEW_WEATHER_ERROR),
         'ValueError',
         'Invalid request format. Request is missing required information'),

        ("{}/current/wash/Richland/all".format(topics.NEW_WEATHER_REQUEST),
         '{}/current/wash/Richland/all'.format(topics.NEW_WEATHER_ERROR),
         'WeatherUndergroundError',
         'Ambiguous location information'),

        ("{}/current/xyz/abc/all".format(topics.NEW_WEATHER_REQUEST),
         '{}/current/xyz/abc/all'.format(topics.NEW_WEATHER_ERROR),
         'WeatherUndergroundError',
         'querynotfound:No cities match your search query'),

        ("{}/history/Richland/Washington/all".format(
            topics.NEW_WEATHER_REQUEST),
         '{}/history/Richland/Washington/all'.format(topics.NEW_WEATHER_ERROR),
         'ValueError',
         'Missing start date. history requests should be of the format:'
         ' weather2/request/history/{region}/{city}/all/start/end'),

        ("{}/hourly/xyz/abc/all".format(topics.NEW_WEATHER_REQUEST),
         '{}/hourly/xyz/abc/all'.format(topics.NEW_WEATHER_ERROR),
         'WeatherUndergroundError',
         'querynotfound:No cities match your search query'),

        ("{}/hourly10days/xyz/abc/all".format(topics.NEW_WEATHER_REQUEST),
         '{}/hourly10days/xyz/abc/all'.format(topics.NEW_WEATHER_ERROR),
         'WeatherUndergroundError',
         'querynotfound:No cities match your search query'),
