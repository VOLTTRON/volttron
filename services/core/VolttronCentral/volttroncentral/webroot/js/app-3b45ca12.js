...
},{"./components/configure-devices":15,"./components/dashboard":24,"./components/devices":28,"./components/login-form":30,"./components/page-not-found":34,"./components/platform":38,"./components/platform-charts":36,"./components/platform-manager":37,"./components/platforms":41,"./stores/authorization-store":54,"./stores/devices-store":57,"./stores/platforms-panel-items-store":60,"history":undefined,"react":undefined,"react-dom":undefined,"react-router":undefined}],2:[function(require,module,exports){
'use strict';
...
var PlatformManager = function (_React$Component) {
    ...
    _createClass(PlatformManager, [{
        ...
        value: function render() {
            ...
            classes.push(this.state.loggedIn ? 'platform-manager--logged-in' : 'platform-manager--not-logged-in');
