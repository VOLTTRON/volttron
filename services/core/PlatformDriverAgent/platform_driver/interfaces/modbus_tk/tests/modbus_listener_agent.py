...
class ListenerAgent(Agent):
    ...
    def on_match(self, peer, sender, bus, topic, headers, message):
        ...
        # Define the modbus_test driver for platform_driver agent, do set point for all registers
        ...
        # Define watts_on_1 (slave id 1) and watts_on_2 (slave id 2) for platform_driver agent, do scrape_all
        print(('SLAVE ID 1', self.scrape_all('watts_on_1')))
        print(('SLAVE ID 2', self.scrape_all('watts_on_2')))

        # Define modbus_tk_test driver for platform_driver agent, do set point, get point, and scrape_all
