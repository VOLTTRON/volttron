...
class GridappsdExample(Agent):
    """
    GridappsdExampleAgent demonstrates how VOLTTRON agent can interact with Gridappsd simulation environment
    """
    ...
    def onstart(self, sender, **kwargs):
        ...
        # Register inputs with Gridappsd and start simulation
        try:
...
#            self.Gridappsd_sim.register_topic_callbacks(topic_callbacks)
