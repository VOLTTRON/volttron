...
def prep_config(volttron_home):
    src_driver = os.getcwd() + '/services/core/PlatformDriver/example_configurations/test_fakedriver.config'
    ...
    with open(new_driver, 'r+') as f:
        ...
        config['registry_config'] = os.getcwd() + '/services/core/PlatformDriver/example_configurations/fake.csv'
        f.seek(0)
        f.truncate()
...
def test_base_historian(volttron_instance):
    ...
    master_uuid = v1.install_agent(agent_dir=get_services_core("PlatformDriver"),
