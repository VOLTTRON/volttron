...
'''
WARNING: RMQ tests are disabled by default, since they overwrite the rabbitmq.conf file when using vcfg
         If you do not have an issue with this file being overwritten, then you may use the rmq tests
