...
import volttron.platform.web.vui_endpoints
...
@pytest.mark.parametrize('segments, expected_keys, expected_route_options',
    [
        ...
        (['vui', 'platforms'], ['agents', 'devices'], {'agents': '/foo/bar/agents', 'devices': '/foo/bar/devices'}),
        (['vui', 'platforms', 'agents'], ['configs', 'rpc'], {'rpc': '/foo/bar/rpc', 'configs': '/foo/bar/configs'}),
...
@pytest.mark.parametrize('option_segments, expected_route_options',
    [
        ([], {}),
        (['foo', 'bar', 'baz'], {'foo': '/foo/bar/foo', 'bar': '/foo/bar/bar', 'baz': '/foo/bar/baz'})
    ])
...
def test_handle_platforms_devices(mock_platform_web_service, method, status):
...
def test_handle_platforms_devices_get_response(mock_platform_web_service):
    # TODO: test GET devices
    pass


def test_handle_platforms_devices_put_response(mock_platform_web_service):
    # TODO: test PUT devices
    pass


def test_handle_platforms_devices_delete_response(mock_platform_web_service):
    # TODO: test DELETE devices
    pass
...
def test_handle_platforms_historians(mock_platform_web_service):
    pass
# TODO: handle_platforms_historians


def test_handle_platforms_historians_historian(mock_platform_web_service):
    pass
# TODO: handle_platforms_historians_historian


def test_handle_platforms_historians_historian_topics(mock_platform_web_service):
    pass
# TODO: handle_platforms_historians_historian_topics
