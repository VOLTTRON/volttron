...
@pytest.mark.parametrize(
    "use_config,args", (
        ...
        (True, ["install", listener_agent_dir, "--tag", "brewster", "--start", "--priority", "1"]),
        (True, ["install", listener_agent_dir, "--tag", "brewster", "--start", "--priority", "20"]),
        (True, ["install", listener_agent_dir, "--tag", "brewster", "--priority", "1"]),
        (True, ["install", listener_agent_dir, "--tag", "hoppy", "--start", "--priority", "1"]),
        (True, ["install", listener_agent_dir, "--tag", "brewster", "--priority", "1"]),
        (True, ["install", listener_agent_dir]),

        (False, ["install", listener_agent_dir, "--tag", "brewster", "--start", "--priority", "1"]),
        (False, ["install", listener_agent_dir, "--tag", "brewster", "--start", "--priority", "20"]),
        (False, ["install", listener_agent_dir, "--tag", "brewster", "--priority", "1"]),
        (False, ["install", listener_agent_dir, "--tag", "hoppy", "--start", "--priority", "1"]),
        (True, ["install", listener_agent_dir]),
