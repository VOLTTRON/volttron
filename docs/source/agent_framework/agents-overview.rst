...
-  Service Agents: These agents peform various data collection or platform management services.  Agents in this category
   include weather service agents which collect weather data from remote sources or operations agents which help users
   maintain situational awareness of their deployment.
...
.. toctree::
   :caption: VOLTTRON Agents

    example_agents/index
    actuator/index
    core_services_agents/index
    historian_agents/index
    operations_agents/index
    volttron_central/index
    third-party-agents
