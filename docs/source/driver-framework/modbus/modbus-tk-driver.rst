...
``services/core/PlatformDriver/master_driver/interfaces/modbus_tk/maps``.
...
in ``services/core/PlatformDriver/master_driver/interfaces/modbus_tk/maps``.
...
``services/core/PlatformDriver/master_driver/interfaces/modbus_tk/maps/maps.yaml``. A command-line tool (described
...
``services/core/PlatformDriver/master_driver/interfaces/modbus_tk/maps/maps.yaml``.
...
.. code-block:: shell
     ...
     $ cd services/core/PlatformDriver/master_driver/interfaces/modbus_tk/maps
...
``services/core/PlatformDriver/master_driver/interfaces/modbus_tk/config_cmd.py``.
