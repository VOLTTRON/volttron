...
Our slack channel (https://volttron-community.slack.com/) is where the VOLTTRON\ :sup:`TM` community at large can ask
questions and meet with others using VOLTTRON\ :sup:`TM`.  Please request access through the email
`volttron@pnnl.gov <mailto:volttron@pnnl.gov?subject=Subscribe%20To%20Slack>`__ to gain access.
...
available through a Zoom meeting.
...
Or Telephone:
    ...
    Meeting ID: 719 191 995
    International numbers available: https://zoom.us/u/dyhrCYeSn
