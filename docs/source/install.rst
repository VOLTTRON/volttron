...
To work with the tech workshop dode clone from the volttron-3rd-tech-meeting
branch by using the following git command.

.. code-block:: bash

    git clone https://github.com/VOLTTRON/volttron/ -b releases/volttron-3rd-tech-meeting
